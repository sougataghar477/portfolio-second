    ...
    <div className="card-body">
      ...
      <div className="flex gap-4">
        <a target="_blank" href={project.link}>
          <button className="btn bg-[#fff] font-bold border-0  text-[#2cb0ff] w-28 hover:bg-slate-100">
            Check Out
          </button>
        </a>
        {project.github && <a target="_blank" href={project.github}>
          <button className="btn  bg-[#fff] border-0 font-bold  text-[#2cb0ff] w-28 hover:bg-slate-100">
            Github
          </button>
        </a>}
      </div>
