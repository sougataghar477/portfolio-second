    ...
    <div className="card-body">
      ...
      <div className="flex gap-4">
        <a target="_blank" href={project.link}>
          <button className="btn bg-[#2cb0ff] font-bold border-0  text-[#fff] w-28 hover:bg-sky-300">
            Check Out
          </button>
        </a>
        {project.github && <a target="_blank" href={project.github}>
          <button className="btn  bg-[#2cb0ff] border-0 font-bold  text-[#fff] w-28 hover:bg-sky-300">
            Github
          </button>
        </a>}
      </div>
